...
class Permisos extends Conexion
{
    ...
    {
    	$query="INSERT INTO permisos(id_permiso, id_tipo_usuario, campo_a, campo_b, campo_c, campo_d, campo_e, campo_f, campo_g, campo_h, campo_i, campo_j, campo_k, campo_l, campo_m, campo_n, campo_o, campo_p,campo_q)
    			values(NULL,
    			'".$this->id_tipo_usuario."',
    			'".$this->campo_a."',
                '".$this->campo_b."',
