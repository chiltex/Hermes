        ...
        <div class="container body">
          <div class="main_container">
            ...
            if (isset($_GET['success'])) {
             ...
             ?>
                  <div class="x_content">
                      <button type="button" name="add" id="add" data-toggle="modal" data-target="#add_data_Modal" class="btn btn-success">Nueva Categoria</button>  
                    <br>
                    <br>
...
<script type="text/javascript">
   $(document).ready(function(){  
      ...
      $('#insert_form').on("submit", function(event){  
           ...
           {  
                $.ajax({  
                     url:"../controller/CategoriaControlador.php?accion=guardar",  
                     method:"POST",  
