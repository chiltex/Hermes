          ...
          <div class="main_container">
            ...
            <div class="right_col" role="main">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Pagina de Formularios de Retorno</h2>
  ...
  <span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span>
             ...
             ?></div>
                  <div class="x_content">
                    ...
                    <a href="../views/saveForm.php" class="btn btn-success">Nuevo Formulario </a>
                    <br>
                    <br>
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered" name="datatable-buttons">
                      ...
                      <tbody>
                        <?php 
                         ...
                         $FormularioRetorno = $misFormularioRetorno->selectALL();
                        
                           # code...
                         
                         foreach ((array)$FormularioRetorno as $row) {
                         echo '
                          <tr>
                           ...
                           <td>
                                    ...
                                    <a href="../controller/FormularioRetornoriaControlador.php?id='.$row["id_form_retorno"].'&accion=eliminar" class="btn btn-danger">Eliminar</a>
                           </td>
                          </tr>
                         ';
                       }
                                  ...
                                  <div class="modal-dialog">  
                                       <div class="modal-content">  
                                            <div class="modal-header">  
                                                 ...
                                                 <h4 class="modal-title">Detalle Formulario de Retorno</h4>  
                                            </div>  
...
<div id="add_data_Modal" class="modal fade">  
      <div class="modal-dialog">  
           <div class="modal-content">  
                <div class="modal-header">  
                     <button type="button" class="close" data-dismiss="modal">&times;</button>  
                     <h4 class="modal-title">Agregar nueva Formulario de Retornoria</h4>  
                </div>  
   ...
   $(document).ready(function(){  
      ...
      $(document).on('click', '.edit_data', function(){  
          var employee_id = $(this).attr("id");  
           ...
           {  
                $.ajax({  
                     url:"../views/modiFormularioRetorno.php",  
                     method:"POST",  
      ...
      $(document).on('click', '.view_data', function(){  
           ...
           {  
                $.ajax({  
                     url:"../views/selectFormularioRetorno.php",  
                     method:"POST",  
                     data:{employee_id:employee_id},  
                     success:function(data){  
                          $('#employee_forms2').html(data);  
        ...
        $(document).on('click', '.save_data', function(){  
           ...
           {  
                $.ajax({  
                     url:"../views/saveFormularioRetorno.php",  
                     method:"POST",  
