                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered" name="datatable-buttons">
                      ...
                      <tbody>
                        <?php 
                         ...
                         $catego = $misCategorias->selectALL1();
                         ...
                         echo '
                          <tr>
                           ...
                           <td>
                            ...
                            echo '<a href="../controller/GrupoProductoControlador.php?id='.$row["id_grupo_producto"].'&accion=change&estado='.$row["estado"].'" class="btn btn-warning glyphicon glyphicon-refresh">Desactivar</a>';
                             # code...
                           }else{
                            echo '<a href="../controller/GrupoProductoControlador.php?id='.$row["id_grupo_producto"].'&accion=change&estado='.$row["estado"].'" class="btn btn-success glyphicon glyphicon-refresh">Activar</a>';
