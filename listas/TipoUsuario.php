  ...
  <span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span>
             ...
             ?></div>
                  <div class="x_content">
                                    ...
                                    <input type="button" name="accion" value="Nueva Tipo de Usuario" id="accion" class="btn btn-success save_data" /> 
                    <br>
                    <br>
                         ...
                         echo '
                          <tr>
                           ...
                           <td>
                                    ...
                                    <a href="../controller/TipoUsuarioControlador.php?id='.$row["id_tipo_usuario"].'&accion=eliminar" class="btn btn-danger">Eliminar</a>
                           </td>
                          </tr>
                         ';
                       }
                                  ...
                                  <div class="modal-dialog">  
                                       <div class="modal-content">  
                                            <div class="modal-header">  
                                                 ...
                                                 <h4 class="modal-title">Detalle Tipo Usuario</h4>  
                                            </div>  
