...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-11-2018 a las 07:55:33
...
DROP TABLE IF EXISTS `detalle_consumible`;
...
DROP TABLE IF EXISTS `detalle_repuestos`;
...
DROP TABLE IF EXISTS `detalle_retorno`;
...
INSERT INTO `events` (`id`, `title`, `color`, `start`, `end`, `descripcion`, `id_usuario`, `id_ticket`) VALUES
(1, 'qwe', '#0071c5', '2018-08-29 00:00:00', '2018-08-30 00:00:00', 'Mecanica', 2, NULL),
(2, 'Prueba 2', '', '2018-09-05 00:00:00', '2018-09-06 00:00:00', 'as', 4, NULL),
(3, 'Prueba 1', '#008000', '2018-08-31 00:00:00', '2018-09-01 00:00:00', 'Se dedica al deporte', 2, NULL),
(4, 'Prueba 4', '', '2018-08-29 00:00:00', '2018-08-30 00:00:00', 'Se dedica al deporte', 4, NULL),
(5, 'Prueba 5', '#FFD700', '2018-08-29 00:00:00', '2018-08-30 00:00:00', 'Se dedica al deporte', 2, NULL);
...
CREATE TABLE `ficha_tecnica` (
  ...
  `latitud` decimal(16,9) DEFAULT NULL,
  `longitud` decimal(16,9) DEFAULT NULL,
...
DROP TABLE IF EXISTS `formulario_retorno`;
...
DROP TABLE IF EXISTS `part_failure`;
...
INSERT INTO `permisos` (`id_permiso`, `id_tipo_usuario`, `campo_a`, `campo_b`, `campo_c`, `campo_d`, `campo_e`, `campo_f`, `campo_g`, `campo_h`, `campo_i`, `campo_j`, `campo_k`, `campo_l`, `campo_m`, `campo_n`, `campo_o`, `campo_p`, `campo_q`) VALUES
...
(2, 2, '', '', '', '', '', '', '', '', '', '', '', '', '../listas/FichaTecnca.php', '', '', '', '../listas/Tickets_u.php?cliente=0&nombre=N/A&codigo_serie=0000&producto=N/A&id_producto=0'),
(3, 3, '', '', '', '', '', '<li><a href=', '<li><a href=', '<li><a href=', '<li><a href=', '', '', '', '', '', '', '', NULL);
...
--
DROP TRIGGER IF EXISTS `permisos_tipo_usuario`;
DELIMITER $$
CREATE TRIGGER `permisos_tipo_usuario` BEFORE INSERT ON `tipo_usuario` FOR EACH ROW INSERT INTO permisos(id_permiso, id_tipo_usuario, campo_a, campo_b, campo_c, campo_d, campo_e, campo_f, campo_g, campo_h, campo_i, campo_j, campo_k, campo_l, campo_m, campo_n, campo_o, campo_p,campo_q)
values(NULL,new.id_tipo_usuario, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL)
$$
DELIMITER ;
...
(5, 'Eduardo ', 'Garcia', 'operador@gmail.com', '27efbda024c402f6b212509eeba68215783b0c2455ef01e27dddfa8fc6525a65', 2);
...
--
ALTER TABLE `detalle_consumible`
  MODIFY `id_detalle_consumible` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `detalle_repuestos`
--
ALTER TABLE `detalle_repuestos`
  MODIFY `id_detalle_repuestos` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `events`
  ADD CONSTRAINT `FK_events` FOREIGN KEY (`id_ticket`) REFERENCES `ticket` (`id_ticket`) ON DELETE CASCADE;
COMMIT;
