<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="../controller/FichaTecnicaControlador.php?accion=guardarNC" method="post">
                         ...
                         ';
                            ...
                            <div class="col-md-6 col-xs-6 col-xs-12">
                              <input type="text" id="nombrec" name="nombrec"  required="required" class="form-control col-md-7 col-xs-12">
                            </div>
                          </div>
                          <div class="form-group">
                          ...
                          <?php 
                            echo '  <input type="hidden" id="bandera" name="bandera" value="'.$bandera.'">';
                           ?>
