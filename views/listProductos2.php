  ...
  require_once "../class/Productos.php";
               ...
               foreach ($contacto as $row) {
                  ...
                  echo'
          				        ...
          				        <td>
                         <a href="../views/saveTicket.php?cliente='.$codigo.'&id_producto='.$row["id_producto"].'&producto='.$row["nombre"].'&codigo_serie='.$row["codigo_serie"].'&nombre='.$empresa.'" class="btn btn-primary">Seleccionar</a>
                         </td>
                          </tr>
                         ';
