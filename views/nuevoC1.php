...
';
 ?>
<form method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="../controller/FichaTecnicaControlador.php?accion=guardarC">  
                          <br>
                          <br>
                          <br>
                          <br>
                         <div class="form-group">
                          ...
                          <?php 
                            echo '<input type="hidden" id="id_cliente" name="id_cliente" value="'.$codigo.'">
                                  ...
                                  <input type="hidden" id="codigo_serie" name="codigo_serie" value="'.$codigo_serie.'">
