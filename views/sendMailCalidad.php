                         ...
                         require_once "../class/Contactos.php";
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <?php 
                              echo '<input type="text" id="nombre" name="nombre" required="required" value="Fabricante" class="form-control col-md-7 col-xs-12">
                              ';
                               ?>
                            </div>
                          </div>
                           <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <?php 
                              echo '
                                 <input type="text" id="destino" name="destino" required="required"  value="la.tec@videojet.com" class="form-control col-md-7 col-xs-12">
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                 <input type="text" id="cc" name="cc" required="required"  value="pcumez@hermez.com.gt" class="form-control col-md-7 col-xs-12"><br>
                               </div>
                              </div>
                               <div class="form-group">
                               ...
                               <div class="col-md-6 col-sm-6 col-xs-12">
                                 <input type="text" id="cc1" name="cc1" required="required"  value="serviciotecnico@hermez.com.gt" class="form-control col-md-7 col-xs-12"><br>
                               </div>
                              </div>
                               <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name"><span class="required">*</span>
                               ...
                               <div class="col-md-6 col-sm-6 col-xs-12">
                                 <input type="text" id="cc2" name="cc2" required="required"  value="npinto@hermez.com.gt" class="form-control col-md-7 col-xs-12"><br>
                               </div>
                              </div>
                              <div class="form-group">
                              <div id="datos"></div>
