 <form role="form" action="../controller/RepuestosControlador.php?accion=modificar" method="post">
              <div class="box-body">
<?php 
require_once "../class/Repuestos.php";
 ...
 ?>
              ...
              <div class="box-footer">
                ...
                <input type="button" class="btn btn-danger" onClick="location.href = '../listas/Repuestos.php'" name="cancel" value="Cancelar" >
              </div>
            </form>